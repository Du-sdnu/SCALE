...
batch_sizes = ['Porn-ANS', 'Porn-AT', 'Porn-DA', 'Porn-Reaper']
epochs = [10, 20, 30, 40, 50, 60, 70, 80]
show_epochs = [20, 50, 80]

'''
# 1.画Precision在Pornsite数据集
accuracies = [
    [0.69, 0.72, 0.75, 0.78, 0.80, 0.82, 0.84, 0.86],
    [0.72, 0.75, 0.78, 0.82, 0.84, 0.85, 0.90, 0.92],
    [0.74, 0.76, 0.80, 0.82, 0.85, 0.87, 0.90, 0.93],
    [0.82, 0.85, 0.89, 0.90, 0.92, 0.94, 0.95, 0.98]
]


# 2. 画AUROC在Pornsite数据集
accuracies = [
    [0.68, 0.73, 0.77, 0.79, 0.80, 0.82, 0.84, 0.84],
    [0.72, 0.74, 0.78, 0.82, 0.81, 0.85, 0.90, 0.92],
    [0.71, 0.75, 0.80, 0.82, 0.85, 0.87, 0.90, 0.91],
    [0.83, 0.87, 0.89, 0.90, 0.92, 0.94, 0.93, 0.97]
]

'''
#3.画准确率Precison 在Porn-FC@15数据集
accuracies = [
    [0.71, 0.72, 0.76, 0.78, 0.74, 0.76, 0.78, 0.74],
    [0.75, 0.75, 0.81, 0.84, 0.84, 0.87, 0.89, 0.92],
    [0.72, 0.74, 0.75, 0.76, 0.82, 0.83, 0.84, 0.87],
    [0.78, 0.80, 0.85, 0.86, 0.88, 0.90, 0.92, 0.94]
]

'''
#4.画准确率AUROC在Porn-FC@15数据集
accuracies = [
    [0.71, 0.73, 0.76, 0.78, 0.75, 0.76, 0.78, 0.77],
    [0.74, 0.77, 0.81, 0.83, 0.85, 0.87, 0.88, 0.89],
    [0.73, 0.76, 0.81, 0.82, 0.83, 0.85, 0.84, 0.86],
    [0.78, 0.80, 0.85, 0.86, 0.88, 0.90, 0.92, 0.92]
]


# 5.画Precision在Porn-RC@15数据集
accuracies = [
[0.65, 0.67, 0.69, 0.71, 0.68, 0.71, 0.70, 0.71],
    [0.71, 0.73, 0.75, 0.76, 0.75, 0.77, 0.79, 0.81],
    [0.72, 0.75, 0.79, 0.81, 0.83, 0.85, 0.87, 0.90],
    [0.74, 0.77, 0.80, 0.85, 0.88, 0.89, 0.90, 0.92]
]

# 6. 画AUROC在Porn-RC@15数据集
accuracies = [
    [0.64, 0.65, 0.68, 0.69, 0.71, 0.72, 0.69, 0.70],
    [0.71, 0.73, 0.74, 0.76, 0.78, 0.81, 0.80, 0.82],
    [0.77, 0.79, 0.81, 0.83, 0.86, 0.85, 0.87, 0.89],
    [0.81, 0.83, 0.87, 0.88, 0.89, 0.90, 0.91, 0.92]
]
'''
...
ax.set_zlabel('Precision', fontsize=16, labelpad=10)
ax.set_zlim(0.6, 1.0)
